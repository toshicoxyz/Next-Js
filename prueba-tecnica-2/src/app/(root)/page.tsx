...
const Home = () => {
  ...
  useEffect(() => {
    // ENLAZAR LOS TYPOS DE POKEMONES
  ...
  return (
    <main className="flex min-h-screen justify-between ">
      <nav className="flex items-center absolute z-50 w-full flex-wrap bg-transparent p-6">
        ...
        <div className="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
          <div className="text-sm lg:flex-grow">
            <div
              onClick={() => setMode(0)} // 0 == Image Mode
            ...
            <div
              onClick={() => setMode(2)} // 2 == Basic Name
              className={`block mt-4 lg:inline-block lg:mt-0 ${
                mode === 2
                  ? day
                    ? 'text-black font-bold'
          ...
          <div>
            {/* <div
              className={`cursor-pointer inline-block text-sm px-4 py-2 leading-none border rounded text-gray-500 border-gray-500 hover:border-white hover:text-white  mt-4 lg:mt-0`}
            >
              Night
            </div> */}
            <Brightness4Icon
              onClick={() => setDay(!day)}
              className={`transition duration-150 ease-out mx-2 cursor-pointer inline-block text-3xl  mt-4 lg:mt-0 ${
                day ? `text-black` : 'text-white'
              }`}
            />
          </div>
          ...
          {mode === 0 || mode === 1 ? (
            <ForceGraph3D
              nodeThreeObject={node => {
                ...
                if (sprites?.front_default && mode === 0) {
                ...
                textSprite.color = day ? 'black' : 'white'
                return textSprite
              }}
